use {
	...
	crate::gui::{element::settings::wallet, GrinGui, Interaction, Message},
...
pub fn data_container<'a>() -> Container<'a, Message> {
	...
	let create_default_wallet_button: Element<Interaction> =
		Button::new(create_default_wallet_button_label_container)
	...
	let select_wallet_button: Element<Interaction> =
		Button::new(select_wallet_button_label_container)
			.style(grin_gui_core::theme::ButtonStyle::Bordered)
			.on_press(Interaction::WalletSetupInitViewInteraction(

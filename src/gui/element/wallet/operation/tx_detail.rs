...
pub fn data_container<'a>(config: &'a Config, state: &'a StateContainer) -> Container<'a, Message> {
	...
	if let Some(ref tx) = state.current_tx {
		...
		let tx_type_label_container = Container::new(tx_type_label)
		...
		let tx_type_value_container = Container::new(tx_type_value)
			.style(grin_gui_core::theme::ContainerStyle::NormalBackground);

		let tx_type_row = Row::new()
			.push(tx_type_label_container)
			.push(tx_type_value_container);
		...
		let shared_tx_id_label_container = Container::new(shared_tx_id_label)
			.style(grin_gui_core::theme::ContainerStyle::NormalBackground);
		...
		let shared_tx_id_value_container = Container::new(shared_tx_id_value)
			.style(grin_gui_core::theme::ContainerStyle::NormalBackground);

		let shared_tx_id_row = Row::new()
			.push(shared_tx_id_label_container)
			.push(shared_tx_id_value_container);
		...
		// Creation Time
		let tx_creation_time_label =
			Text::new(format!("{}:  ", localized_string("tx-creation-time")))
				.size(DEFAULT_FONT_SIZE)
				.horizontal_alignment(alignment::Horizontal::Left);

		let tx_creation_time_label_container = Container::new(tx_creation_time_label)
			.style(grin_gui_core::theme::ContainerStyle::NormalBackground);
		...
		let tx_creation_time_value_container = Container::new(tx_creation_time_value)
			.style(grin_gui_core::theme::ContainerStyle::NormalBackground);

		let tx_creation_time_row = Row::new()
			.push(tx_creation_time_label_container)
			.push(tx_creation_time_value_container);
		...
		let ttl_cutoff_label_container = Container::new(ttl_cutoff_label)
			.style(grin_gui_core::theme::ContainerStyle::NormalBackground);
		...
		let ttl_cutoff_value_container = Container::new(ttl_cutoff_value)
			.style(grin_gui_core::theme::ContainerStyle::NormalBackground);

		let ttl_cutoff_row = Row::new()
			.push(ttl_cutoff_label_container)
			.push(ttl_cutoff_value_container);
		...
		let confirmed_label_container = Container::new(confirmed_label)
			.style(grin_gui_core::theme::ContainerStyle::NormalBackground);
		...
		let confirmed_value_container = Container::new(confirmed_value)
			.style(grin_gui_core::theme::ContainerStyle::NormalBackground);

		let confirmed_row = Row::new()
			.push(confirmed_label_container)
			.push(confirmed_value_container);
		...
		// Confirmation Time
		let tx_confirmation_time_label =
			Text::new(format!("{}:  ", localized_string("tx-confirmation-time")))
				.size(DEFAULT_FONT_SIZE)
				.horizontal_alignment(alignment::Horizontal::Left);

		let tx_confirmation_time_label_container = Container::new(tx_confirmation_time_label)
			.style(grin_gui_core::theme::ContainerStyle::NormalBackground);
		...
		let tx_confirmation_time_value_container = Container::new(tx_confirmation_time_value)
			.style(grin_gui_core::theme::ContainerStyle::NormalBackground);

		let tx_confirmation_time_row = Row::new()
			.push(tx_confirmation_time_label_container)
			.push(tx_confirmation_time_value_container);
		column = column
		...
		let tx_num_inputs_label_container = Container::new(tx_num_inputs_label)
			.style(grin_gui_core::theme::ContainerStyle::NormalBackground);
		...
		let tx_num_inputs_value_container = Container::new(tx_num_inputs_value)
			.style(grin_gui_core::theme::ContainerStyle::NormalBackground);

		let tx_num_inputs_row = Row::new()
			.push(tx_num_inputs_label_container)
		...
		let tx_num_outputs_label_container = Container::new(tx_num_outputs_label)
			.style(grin_gui_core::theme::ContainerStyle::NormalBackground);
		...
		let tx_num_outputs_value_container = Container::new(tx_num_outputs_value)
			.style(grin_gui_core::theme::ContainerStyle::NormalBackground);

		let tx_num_outputs_row = Row::new()
			.push(tx_num_outputs_label_container)
			.push(tx_num_outputs_value_container);
		column = column
			.push(tx_num_outputs_row)
			.push(Space::new(Length::Fixed(0.0), Length::Fixed(row_spacing)));

		// Amount Credited
		let tx_amount_credited_label =
			Text::new(format!("{}:  ", localized_string("tx-amount-credited")))
				.size(DEFAULT_FONT_SIZE)
				.horizontal_alignment(alignment::Horizontal::Left);

		let tx_amount_credited_label_container = Container::new(tx_amount_credited_label)
			.style(grin_gui_core::theme::ContainerStyle::NormalBackground);

		let tx_amount_credited_value =
			Text::new(format!("{}", amount_to_hr_string(tx.amount_credited, true)))
				.size(DEFAULT_FONT_SIZE)
				.horizontal_alignment(alignment::Horizontal::Left);

		let tx_amount_credited_value_container = Container::new(tx_amount_credited_value)
			.style(grin_gui_core::theme::ContainerStyle::NormalBackground);

		let tx_amount_credited_row = Row::new()
			.push(tx_amount_credited_label_container)
		...
		// Amount Debited
		let tx_amount_debited_label =
			Text::new(format!("{}:  ", localized_string("tx-amount-debited")))
				.size(DEFAULT_FONT_SIZE)
				.horizontal_alignment(alignment::Horizontal::Left);

		let tx_amount_debited_label_container = Container::new(tx_amount_debited_label)
			.style(grin_gui_core::theme::ContainerStyle::NormalBackground);

		let tx_amount_debited_value =
			Text::new(format!("{}", amount_to_hr_string(tx.amount_debited, true)))
				.size(DEFAULT_FONT_SIZE)
				.horizontal_alignment(alignment::Horizontal::Left);

		let tx_amount_debited_value_container = Container::new(tx_amount_debited_value)
			.style(grin_gui_core::theme::ContainerStyle::NormalBackground);

		let tx_amount_debited_row = Row::new()
			.push(tx_amount_debited_label_container)
			.push(tx_amount_debited_value_container);
		column = column
		...
		let tx_fee_label_container = Container::new(tx_fee_label)
			.style(grin_gui_core::theme::ContainerStyle::NormalBackground);
		...
		let tx_fee_value_container = Container::new(tx_fee_value)
			.style(grin_gui_core::theme::ContainerStyle::NormalBackground);

		let tx_fee_row = Row::new()
			.push(tx_fee_label_container)
			.push(tx_fee_value_container);
		column = column
			.push(tx_fee_row)
			.push(Space::new(Length::Fixed(0.0), Length::Fixed(row_spacing)));

		// Net Difference
		let tx_net_difference_label =
			Text::new(format!("{}:  ", localized_string("tx-net-difference")))
				.size(DEFAULT_FONT_SIZE)
				.horizontal_alignment(alignment::Horizontal::Left);

		let tx_net_difference_label_container = Container::new(tx_net_difference_label)
			.style(grin_gui_core::theme::ContainerStyle::NormalBackground);
		...
		let tx_net_difference_value_container = Container::new(tx_net_difference_value)
			.style(grin_gui_core::theme::ContainerStyle::NormalBackground);

		let tx_net_difference_row = Row::new()
			.push(tx_net_difference_label_container)
			.push(tx_net_difference_value_container);
		column = column

...
use {
	...
	grin_gui_core::theme::{
		Button, Card, Column, Container, Element, PickList, Row, Scrollable, Text,
	},
...
pub fn exit_card() -> Card<'static, Message> {
	...
	let cancel_button: Element<Interaction> = Button::new(cancel_button_label)
		.style(grin_gui_core::theme::ButtonStyle::Primary)
...
pub fn error_card(error_cause: String) -> Card<'static, Message> {
	Card::new(
